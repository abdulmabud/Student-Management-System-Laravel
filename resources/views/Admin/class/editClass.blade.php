                ...
                <tr>
                    ...
                    <td>
                        <select name="classStatus" id="" class="form-control">
                            <option value="Published" {{ $class->classStatus == 'Published' ? 'selected' : '' }}>Published</option>
                            <option value="Unpublished" {{ $class->classStatus == 'Unpublished' ? 'selected' : '' }}>Unpublished</option>
                        </select>
                    </td>
                </tr>
                <tr>
